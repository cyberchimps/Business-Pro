...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
		...
		->section("Front Page")
		->open_outersection()
			->section_order($themeslug."_front_section_order", "Blog Page Re-Order", array('options' => array("synapse_page_slider" => "Content Slider", "synapse_callout_section" => "Callout Section", "synapse_twitterbar_section" => "Twitter Bar", "synapse_index_carousel_section" => "Carousel", "synapse_portfolio_element" => "Portfolio", "synapse_box_section" => "Boxes"), "default" => 'synapse_index'))
		->close_outersection()
		->subsection("Content Slider")
			->select($themeslug.'_front_slider_category', 'Select the post category', array( 'options' => $blogoptions ))
