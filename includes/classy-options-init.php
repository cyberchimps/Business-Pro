...
")
	...
	->section("Header")
		...
		->section("Front Page")
		->open_outersection()
			->section_order($themeslug."_front_section_order", "Drag & Drop Elements", array('options' => array("business_page_slider" => "Content Slider", "business_callout_section" => "Callout Section", "business_twitterbar_section" => "Twitter Bar", "business_index_carousel_section" => "Carousel", "business_front_page_custom" => "Custom", "business_portfolio_element" => "Portfolio","business_product_element" => "Product", "business_box_section" => "Boxes"), "default" => 'business_page_slider,business_callout_section,business_box_section'))
		->close_outersection()
		->subsection("Slider")
		...
		->subsection_end()
		->subsection("Custom")
			->textarea($themeslug."_front_custom_html", "Custom HTML")
		->subsection_end()
		...
		->subsection("Portfolio")
			...
			->select($themeslug.'_front_portfolio_category', 'Portfolio Category', array( 'options' => $customportfolio ))
