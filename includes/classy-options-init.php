...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
		...
		->section("Front Page")
		->open_outersection()
			->section_order($themeslug."_front_section_order", "Front Page Re-Order", array('options' => array("business_page_slider" => "Content Slider", "business_callout_section" => "Callout Section", "business_twitterbar_section" => "Twitter Bar", "business_index_carousel_section" => "Carousel", "business_portfolio_element" => "Portfolio","business_product_element" => "Product", "business_box_section" => "Boxes"), "default" => 'business_page_slider,business_callout_section,business_twitterbar_section'))
		->close_outersection()
		->subsection("Slider")
		...
		->subsection("Product")
			...
			->select($themeslug."_front_product_type", "Text Align", array( 'options' => array("key1" => "Image", "key2" => "Video")))
			...
			->text($themeslug."_front_product_link_text", "Link", array('default' => 'Buy Now'))
		->subsection_end()
		->section("Blog")
		->open_outersection()
			->section_order($themeslug."_blog_section_order", "Blog Page Re-Order", array('options' => array("business_post" => "Post Page", "business_page_slider" => "Content Slider","business_callout_section" => "Callout Section", "business_twitterbar_section" => "Twitter Bar", "business_index_carousel_section" => "Carousel", "business_portfolio_element" => "Portfolio", "business_product_element" => "Product","business_box_section" => "Boxes"), "default" => 'business_post'))
		->close_outersection()
		...
		->subsection("Product Options")
			...
			->select($themeslug."_blog_product_type", "Text Align", array( 'options' => array("key1" => "Image", "key2" => "Video")))
			...
			->text($themeslug."_blog_product_link_text", "Link", array('default' => 'Buy Now'))
		->subsection_end()
		->subsection("SEO")
